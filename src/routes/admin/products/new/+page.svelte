<script lang="ts">
  ...
  import { MarketplaceConfig, DataProduct, DisplayOptions} from '$lib/interfaces';
  ...
  let product: DataProduct = new DataProduct(generateRandomString(4), "", "", "", "", "Published", "BigQueryTable", "", "", "", ["API"], ["internal", "partner", "external"], []);

  if (appService.currentSiteData && appService.currentSiteData.bqtables.length > 0) {
