  ...
  <div class="left_menu_page_left_list">
    ...
    >
      <svg
        ...
        width="20px"
        class={getClassName("side_menu_button_logo", "datagen")}
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
        ><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
          id="SVGRepo_tracerCarrier"
